...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [self.backButton setImage:[UIImage imageNamed:@"iconfont-shangyishou"] forState:(UIControlStateNormal)];
        ...
        [self.frontButton setImage:[UIImage imageNamed:@"iconfont-xiayishou-2"] forState:(UIControlStateNormal)];
