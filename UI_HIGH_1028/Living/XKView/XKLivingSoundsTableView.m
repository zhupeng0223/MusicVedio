...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        self.rankingCell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (void)turnMore:(UIButton *)button{
    switch (button.tag) {
        case 1000:{
            ...
            NSString *blockMessage = [NSString stringWithFormat:@"本地台,http://live.ximalaya.com/live-web/v1/getRadiosListByType?device=iPhone&pageNum=1&pageSize=30&provinceCode=%@&radioType=2",cityID];
