...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.leftBtn.titleBtn addTarget:self action:@selector(titleBtnAction:) forControlEvents:(UIControlEventTouchUpInside)];
    [cell.centerBtn.titleBtn addTarget:self action:@selector(titleBtnAction:) forControlEvents:(UIControlEventTouchUpInside)];
    [cell.rightBtn.titleBtn addTarget:self action:@selector(titleBtnAction:) forControlEvents:(UIControlEventTouchUpInside)];
...
#pragma mark - 收藏
- (void)titleBtnAction:(DropButton *)button {
    self.isCollect = !self.isCollect;
    if (self.isCollect) {
        [button setImage:[UIImage imageNamed:@"wujiaoxingman"] forState:(UIControlStateNormal)];
    } else {
        [button setImage:[UIImage imageNamed:@"wujiaoxingkong"] forState:(UIControlStateNormal)];
    }
}
